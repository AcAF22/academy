...
INSERT INTO Employees(empid, lastname, firstname, title, titleofcourtesy, birthdate, hiredate, address, city, region, postalcode,
 country, phone, mgrid)
  VALUES(1, N'Davis', N'Sara', N'CEO', N'Ms.', '1958-12-08 00:00:00', '2002-05-01 00:00:00.000', N'7890 - 20th Ave. E., Apt. 2A', N'Seattle', N'WA', N'10003', N'USA', N'(206) 555-0101', NULL);
...
SELECT
  ...
  (date_trunc('month', O.orderdate) + 
    interval '1 month' - interval '1 day')::date AS ordermonth,
  SUM(OD.qty) AS qty
FROM Orders AS O
  JOIN OrderDetails AS OD
    ON OD.orderid = O.orderid
GROUP BY custid, (date_trunc('month', O.orderdate) + 
