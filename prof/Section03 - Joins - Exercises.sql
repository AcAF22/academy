...
SELECT E.empid, E.firstname, E.lastname, N.num
FROM employees AS E
...
INSERT INTO dttable VALUES(date '20090612' + counter);
counter := counter + 1;
END LOOP;
...
SELECT E.empid, D.datej AS dt
FROM employees AS E
CROSS JOIN dttable AS D
ORDER BY empid;
...
SELECT CU.custid, CU.companyname, O.orderid, O.orderdate
FROM customers AS CU
...
SELECT CU.custid, CU.companyname
FROM customers AS CU
LEFT JOIN orders AS O
ON CU.custid = O.custid
